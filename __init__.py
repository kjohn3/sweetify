...
def artists_and_songs(session):
	...
	json2 = open('/var/www/FlaskApp/FlaskApp/JSON/artists.txt', 'r').read()
	artists = ast.literal_eval(json2)
	json3 = open('/var/www/FlaskApp/FlaskApp/JSON/genre_descriptions.txt', 'r').read()
	genres = ast.literal_eval(json3)
	json4 = open('/var/www/FlaskApp/FlaskApp/JSON/years.txt', 'r').read()
	years = ast.literal_eval(json4)
	json5 = open('/var/www/FlaskApp/FlaskApp/JSON/artist_genres.txt', 'r').read()
	artist_genres = ast.literal_eval(json5)
	json6 = open('/var/www/FlaskApp/FlaskApp/JSON/related_genres.txt', 'r').read()
	related_genres = ast.literal_eval(json6)
	json7 = open('/var/www/FlaskApp/FlaskApp/JSON/all_songs_association.txt', 'r').read()
